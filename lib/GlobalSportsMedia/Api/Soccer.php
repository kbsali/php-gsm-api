...
class Soccer extends AbstractApi
{
    ...
    /**
     * @link http://client.globalsportsmedia.com/documentation/soccer/functions/get_groups
     * @param  array $params array of optional params
     * @return \SimpleXMLElement
     */
    ...
    public function get_matches_live(array $params = array())
    {
        $defaults = array(
            ...
            'type' => null, // area|season|match
        );

        return $this->get('/soccer/get_matches_live', $defaults, $params);
    }
    ...
    /**
     * @link http://client.globalsportsmedia.com/documentation/soccer/functions/get_referees
     * @param  array $params array of optional params
     * @return \SimpleXMLElement
     */
